...
/*функция сортировки:
Имеем вектор произвольной длины, состоящий из объектов, которые принимают одно из 3-ёх значений - R, G и B.
Так же имеем правило сортировки, которое указывает, какое из значиний должно быть в начале ("минимальное"), в середине и в конце ("максимальное") вектора.
